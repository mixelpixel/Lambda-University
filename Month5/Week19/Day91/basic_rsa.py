...
class Rsa:
    ...
    def __init__(self, bitlen):
        ...
        self.bitlen = bitlen
        # TODO - implement RSA (n & e are public, d is private/secure/offline)
    ...
    def encrypt_string(self, plaintext):
        ...
        # nums = [str(ord(c)) for c in plaintext]
        # bignum = int(''.join(nums))
        # return pickle.dumps(self.encrypt_int(bignum))
